export const Permissions = {
    ...
    ACCOUNT_NOTIFICATIONS_MANAGE: "account.notifications.manage",
    ACCOUNT_PRIVACY_MANAGE: "account.privacy.manage",
    ACCOUNT_SECURITY_MANAGE: "account.security.manage",
    ACCOUNT_HELP_VIEW: "account.help.view",
    ACCOUNT_LOGOUT: "account.logout",

    // Rider
    RIDER_DASHBOARD_VIEW: "rider.dashboard.view",
    RIDER_RIDE_CREATE: "rider.ride.create",
    RIDER_RIDE_VIEW: "rider.ride.view",
    RIDER_RIDE_CANCEL: "rider.ride.cancel",
    RIDER_SAVED_PLACES_VIEW: "rider.saved_places.view",
    ...
    DRIVER_RIDE_VIEW: "driver.ride.view",
    DRIVER_RIDE_ACCEPT: "driver.ride.accept",
    DRIVER_RIDE_START: "driver.ride.start",
    DRIVER_RIDE_COMPLETE: "driver.ride.complete",
    DRIVER_AVAILABILITY_VIEW: "driver.availability.view",
    ...
    DRIVER_PROFILE_VIEW: "driver.profile.view",
    DRIVER_PROFILE_EDIT: "driver.profile.edit",
